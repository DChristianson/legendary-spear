...
soundTrack_clear
            bne soundTrack_lo
            ;lda #GALLOP_PATTERN - optimization y is 0
            sty sound_track ; save gallop pattern
soundTrack_lo
...
movePlayer_vert_start
            lda player_charge
            ror
            bcs movePlayer_end   ; move at half speed while charging
            lda #$20             ;2  -- replace A
            bit SWCHA            ;3  23
